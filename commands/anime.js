...
module.exports ={
    name: 'anime',
    aliases:['ani','a','animelife','anime-life'],
    description:"So you have decided to choose anime",
    async execute(client, message, args, Discord){
        
        let embed = new Discord.MessageEmbed()

        .setTitle('**Genres**')
        .setDescription('These are the genres you can choose anime from.')
        .setColor('#64c6e7')
        .setURL('https://discord.gg/adnga86cdA')
        .setFooter('Page 1/3 | Use the commands to get the genre you desire.','https://imgur.com/22ncPbk.png')
        ...
        .setColor('#64c6e7')
        .setURL('https://discord.gg/adnga86cdA')
        .setFooter('Page 2/3 | Use ?r or ?random to get a random anime','https://imgur.com/22ncPbk.png')
        .addFields(
